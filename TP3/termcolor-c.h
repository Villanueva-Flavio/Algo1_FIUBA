// Serie de 15 funciones de texto y 9 de fondo para Stdout
// Libreria importada de Github
// Creditos: https://github.com/ararslan/termcolor-c
...
/* 
* Funcion que verifica que el color de funcion utilizado sea soportado por el sistema operativo
*/
...
/*
* Limpia los colores de fg y bg que existan previamente
* Hay que utilizarlo idealmente cada vez que se coloque un color previamente
*/
void limpiar_stdout(){
    printf("\033[0m");
    fflush(stdout);
